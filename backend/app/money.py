...
# Базовая валюта портфеля. Совокупный капитал и разбивки считаются только по
# рублёвой части: складывать позиции в USD, HKD и CNY с рублёвыми без пересчёта
# по курсам — значит молча завышать капитал. Пересчёт по курсам — задача
# следующей фазы. Константа лежит здесь, а не в аналитике, потому что от неё
