...
def _buy(op_id: str, figi: str) -> dict:
    return {
        "id": op_id,
...
def _mock_broker(operations: list[dict]) -> None:
    ...
    lists = {
        "Bonds": [{"figi": BOND_FIGI, "ticker": "SU26238RMFS4", "isin": BOND_ISIN, "name": "ОФЗ 26238"}],
        "Etfs": [{"figi": ETF_FIGI, "ticker": "TMOS", "isin": ETF_ISIN, "name": "Тинькофф iMOEX"}],
    }
