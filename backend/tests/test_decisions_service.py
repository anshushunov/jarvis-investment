...
@pytest.fixture
def hkd_instruments(session, account) -> tuple[Instrument, Instrument]:
    """Две гонконгские бумаги решения №1 — обе в HKD, а не в рубле по умолчанию.
    ...
    target = Instrument(isin="HK0000051877", ticker="HK05", secid="HK05",
                        kind="share", currency="HKD")
